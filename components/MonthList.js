...
const MonthList = ({ newPrices, dates, avgs }) => {
  ...
  //taulukko alasvetovalikon aikoja varten
  ...
  return (
    <List.Section title="">
      <List.Accordion
        title="Näytä tuntihinnat" descriptionStyle={style.titleStyle} titleStyle={style.titleStyle} style={{ backgroundColor: '#757575' }}>
        ...
        <Divider style={{ backgroundColor: '#2B2B2B' }} />
        <List.Accordion
          title={dates[28]} description={'Päivän ka: ' + avgs[28] + 'snt/kWh'} titleStyle={style.titleStyle} style={{ backgroundColor: '#757575' }} descriptionStyle={style.titleDescriptionStyle} >
        ...
        <List.Accordion
          ...
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[4]} titleStyle={style.titleStyleItems} description={newPrices[724] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[5]} titleStyle={style.titleStyleItems} description={newPrices[725] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[6]} titleStyle={style.titleStyleItems} description={newPrices[726] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[7]} titleStyle={style.titleStyleItems} description={newPrices[727] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[8]} titleStyle={style.titleStyleItems} description={newPrices[728] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[9]} titleStyle={style.titleStyleItems} description={newPrices[729] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[10]} titleStyle={style.titleStyleItems} description={newPrices[730] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[11]} titleStyle={style.titleStyleItems} description={newPrices[731] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[12]} titleStyle={style.titleStyleItems} description={newPrices[732] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[13]} titleStyle={style.titleStyleItems} description={newPrices[733] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[14]} titleStyle={style.titleStyleItems} description={newPrices[734] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[15]} titleStyle={style.titleStyleItems} description={newPrices[735] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[16]} titleStyle={style.titleStyleItems} description={newPrices[736] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[17]} titleStyle={style.titleStyleItems} description={newPrices[737] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[18]} titleStyle={style.titleStyleItems} description={newPrices[738] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[19]} titleStyle={style.titleStyleItems} description={newPrices[739] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[20]} titleStyle={style.titleStyleItems} description={newPrices[740] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[21]} titleStyle={style.titleStyleItems} description={newPrices[741] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[22]} titleStyle={style.titleStyleItems} description={newPrices[742] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
          <List.Item title={times[23]} titleStyle={style.titleStyleItems} description={newPrices[743] + 'snt/kWh'} descriptionStyle={style.descriptionStyleItems} />
          <Divider style={{ backgroundColor: 'grey' }} />
        </List.Accordion>
        <Divider style={{ backgroundColor: '#2B2B2B' }} />
      </List.Accordion>
