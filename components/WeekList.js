...
const Weeklist = () => {
  ...
  function getDates(dates) {
    const tempArr2 = []
    for (let i = 0; i < (dates.length-24); i++) { //jostain syystä prices-taulussa on yksi vuorukausi enemmän
      tempArr2.push(Number(dates[i].value))
      console.log(Number(dates[i].value))
    }
    setDates(tempArr2)
  }
