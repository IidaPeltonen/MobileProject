...
const YearList = ({ newPrices, dates, avgs, monthsLast }) => {
  ...
  //jos kkssa on 28 päivää, näytetään 27 indeksiä
  if (monthsLast === 28) {
    return (
      <List.Section title="">
        <List.Accordion
  ...
  //jos kkssa on 29 päivää, näytetään 30 indeksiä
  if (monthsLast === 29) {
    return (
      <List.Section title="">
        <List.Accordion
  ...
  //jos kkssa on 30 päivää, näytetään 29 indeksiä
  if (monthsLast === 30) {
    return (
      <List.Section title="">
        <List.Accordion
  ...
  //jos kkssa on 31 päivää, näytetään kaikki
  else {
    return (
      <List.Section title="">
        <List.Accordion
